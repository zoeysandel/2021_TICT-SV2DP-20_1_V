...
//        adao.create(adres);
    ...
    private static void testOVChipkaartDAO(OVChipkaartDAO odao, ReizigerDAO rdao) throws SQLException
    {
        ...
        Adres adres = new Adres(103, "1111TR", "88", "Pieter Janstraat", "Groningen", 100);
        Reiziger pieter = new Reiziger(100, "P", "", "Kerrie", LocalDate.of(2202, 4, 12), adres);

        rdao.create(pieter);

        List<OVChipkaart> ovchipkaarten = odao.findByReiziger(pieter);
        System.out.println("[Test] OVChipkaartDAOPSQL.findByReiziger() geeft de volgende adressen:");
