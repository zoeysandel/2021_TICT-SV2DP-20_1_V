...
-- TODO: INNER JOIN?
SELECT u.cursus cursus_code, u.begindatum, count(i.cursist) totaal_inschrijvingen
FROM uitvoeringen u
...
-- TODO: DATE_PART gebruiken voor het pakken van elementen uit een datum
...
-- TODO: DISTINCT nodig voor het alleen selecteren unieke commissie
